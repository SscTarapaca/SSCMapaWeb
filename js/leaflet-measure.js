...
var controlTemplate = _.template("<a class=\"<%= model.className %>-toggle js-toggle\" href=\"#\" title=\"Medir distancias y áreas\"></a>\n<div class=\"<%= model.className %>-interaction js-interaction\">\n  <div class=\"js-startprompt startprompt\">\n    <h3>Medir distancias y áreas</h3>\n    <ul class=\"tasks\">\n      <a href=\"#\" class=\"js-start start\">Crear una nueva medición</a>\n    </ul>\n  </div>\n  <div class=\"js-measuringprompt\">\n    <h3>Medir distancias y áreas</h3>\n    <p class=\"js-starthelp\">Comience a crear una medición añadiendo puntos al mapa</h3>\n    <div class=\"js-results results\"></div>\n    <ul class=\"js-measuretasks tasks\">\n      <li><a href=\"#\" class=\"js-cancel cancel\">Cancelar</a></li>\n      <li><a href=\"#\" class=\"js-finish finish\">Terminar medición</a></li>\n    </ul>\n  </div>\n</div>");
...
var pointPopupTemplate = _.template("<h3>Localización del punto</h3>\n<p><%= model.lastCoord.dms.y %> <span class=\"coorddivider\">/</span> <%= model.lastCoord.dms.x %></p>\n<p><%= humanize.numberFormat(model.lastCoord.dd.y, 6) %> <span class=\"coorddivider\">/</span> <%= humanize.numberFormat(model.lastCoord.dd.x, 6) %></p>\n<ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">Centrar en esta localización</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">Delete</a></li>\n</ul>");
var linePopupTemplate = _.template("<h3>Medición linear</h3>\n<p><%= model.lengthDisplay %></p>\n<ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">Centrar en esta línea</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">Delete</a></li>\n</ul>");
var areaPopupTemplate = _.template("<h3>Medición de la superficie</h3>\n<p><%= model.areaDisplay %></p>\n<p><%= model.lengthDisplay %> Perímetro</p>\n<ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">Centrar en esta área</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">Delete</a></li>\n</ul>");
...
L.Control.Measure = L.Control.extend({
  ...
  options: {
    ...
    secondaryLengthUnit: 'Kilómetros',
  ...
  _handleMeasureDoubleClick: function () {
    ...
    if (latlngs.length > 2) {
      latlngs.push(_.first(latlngs)); // close path to get full Perímetro measurement for areas
    }
...
module.exports = {
  ...
  sqfeet: {
    factor: 10.7639,
    display: 'Pies cuadrados',
    decimals: 0
  },
  sqmeters: {
    factor: 1,
    display: 'Metros cuadrados',
    decimals: 0
  },
  sqmiles: {
    factor: 0.000000386102,
    display: 'Millas cuadradas',
    decimals: 2
  }
};
},{}]},{},[19]);
